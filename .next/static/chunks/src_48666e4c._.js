...
"[project]/src/app/earth/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function loadScript(src) {
    return new Promise((resolve, reject)=>{
        ...
        s.async = true;
        s.onload = ()=>resolve();
        s.onerror = ()=>reject(new Error("Failed to load ".concat(src)));
...
function ZodiacScene() {
    ...
    const labelContainerRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ZodiacScene.useEffect": ()=>{
            let cleanup;
            const init = {
                "ZodiacScene.useEffect.init": async ()=>{
                    ...
                    seasonPoints.forEach({
                        "ZodiacScene.useEffect.init": (p)=>{
                    ...
                    }["ZodiacScene.useEffect.init"]);
                    // 相机
                    camera.position.set(0, 0, 5);
                    camera.lookAt(0, 0, 0);
                    // 日期计算
                    const julianDate = {
                        "ZodiacScene.useEffect.init.julianDate": (date)=>{
                    ...
                    }["ZodiacScene.useEffect.init.julianDate"];
                    const calculatePositions = {
                        "ZodiacScene.useEffect.init.calculatePositions": (date)=>{
                    ...
                    }["ZodiacScene.useEffect.init.calculatePositions"];
                    // 日期 UI 初始化
                    const setToday = {
                        "ZodiacScene.useEffect.init.setToday": ()=>{
                            const now = new Date();
                            ...
                            if (inputRef.current) inputRef.current.value = "".concat(year, "-").concat(month, "-").concat(day, "T").concat(hours, ":").concat(minutes);
                        }
                    }["ZodiacScene.useEffect.init.setToday"];
                    let currentDate = new Date();
                    setToday();
                    const updatePositions = {
                        "ZodiacScene.useEffect.init.updatePositions": ()=>{
                            ...
                            if (infoRef.current) {
                                infoRef.current.textContent = "观测日期: ".concat(currentDate.toLocaleDateString(), "\n地球的黄经: ").concat(pos.earthLongitude.toFixed(2), "°\n太阳的视黄经: ").concat(pos.sunLongitude.toFixed(2), "°\n太阳位于: ").concat(currentZodiac);
                            }
                        }
                    }["ZodiacScene.useEffect.init.updatePositions"];
                    (_inputRef_current = inputRef.current) === null || _inputRef_current === void 0 ? void 0 : _inputRef_current.addEventListener("change", {
                        "ZodiacScene.useEffect.init": ()=>{
                            var _inputRef_current;
                            if ((_inputRef_current = inputRef.current) === null || _inputRef_current === void 0 ? void 0 : _inputRef_current.value) currentDate = new Date(inputRef.current.value);
                            updatePositions();
                        }
                    }["ZodiacScene.useEffect.init"]);
                    const onResize = {
                        "ZodiacScene.useEffect.init.onResize": ()=>{
                    ...
                    let raf = 0;
                    const animate = {
                        "ZodiacScene.useEffect.init.animate": ()=>{
                    ...
                    cleanup = ({
                        "ZodiacScene.useEffect.init": ()=>{
                            ...
                            try {
                                var _containerRef_current, _labelContainerRef_current;
                                ...
                                (_labelContainerRef_current = labelContainerRef.current) === null || _labelContainerRef_current === void 0 ? void 0 : _labelContainerRef_current.removeChild(labelRenderer.domElement);
                            } catch (e) {}
                        }
                    })["ZodiacScene.useEffect.init"];
                }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$styled$2d$jsx$2f$style$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                id: "60ab5743d4013604",
                children: ".label.jsx-60ab5743d4013604{color:#fff;background:rgba(0,0,0,.6);border-radius:4px;padding:2px 4px;font-family:sans-serif}"
...
_s(ZodiacScene, "nYECWSNl52UbTyfWlvHb9NhzOLA=");
_c = ZodiacScene;
function SevenStarsScene() {
    ...
    const infoRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const [hemisphere, setHemisphere] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("north");
    const [latitude, setLatitude] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(35);
    ...
    const [day, setDay] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(21);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SevenStarsScene.useEffect": ()=>{
            let cleanup;
            const init = {
                "SevenStarsScene.useEffect.init": async ()=>{
                    await loadScript("https://unpkg.com/three@0.132.2/build/three.min.js");
                    await loadScript("https://cdn.jsdelivr.net/npm/three@0.132.2/examples/js/controls/OrbitControls.js");
                    // @ts-ignore
                    const THREE = window.THREE;
                    ...
                    const orientPts = [];
                    orientation.forEach({
                        "SevenStarsScene.useEffect.init": (name, i)=>{
                    ...
                    }["SevenStarsScene.useEffect.init"]);
                    let objectsToRemove = [];
                    let northPoleLabel = null;
                    let southPoleLabel = null;
                    const rebuild = {
                        "SevenStarsScene.useEffect.init.rebuild": ()=>{
                            objectsToRemove.forEach({
                                "SevenStarsScene.useEffect.init.rebuild": (obj)=>{
                                    try {
                                        var _obj_geometry_dispose, _obj_geometry, _obj_material_dispose, _obj_material;
                                        scene.remove(obj);
                            ...
                            if (product > 1) {
                                ...
                                const r1 = Tc - Ts / 2;
                                const r2 = Tc + Ts / 2;
                                sunrise = "".concat(Math.floor(r1), ":").concat(String(Math.floor(r1 % 1 * 60)).padStart(2, "0"));
                                sunset = "".concat(Math.floor(r2), ":").concat(String(Math.floor(r2 % 1 * 60)).padStart(2, "0"));
                            }
                            if (infoRef.current) {
                                infoRef.current.innerHTML = "太阳周日视运动可视化<br/>观测位置：".concat(hemisphere === "north" ? "北纬" : "南纬", " ").concat(Math.abs(lat), "°<br/>观测日期：").concat(year, "年").concat(month, "月").concat(day, "日<br/>赤纬角：").concat((delta * 180 / Math.PI).toFixed(2), "°<br/>日照时长：").concat(isExtreme ? Ts === 24 ? "24小时0分钟" : "0小时0分钟" : "".concat(Math.floor(Ts), "小时").concat(Math.floor(Ts % 1 * 60), "分钟"), "<br/>日出时间：").concat(isExtreme ? Ts === 24 ? "极昼" : "极夜" : sunrise, "<br/>日落时间：").concat(isExtreme ? Ts === 24 ? "极昼" : "极夜" : sunset);
                            }
                        }
                    }["SevenStarsScene.useEffect.init.rebuild"];
                    const onResize = {
                        "SevenStarsScene.useEffect.init.onResize": ()=>{
                            if (!containerRef.current) return;
                            camera.aspect = containerRef.current.clientWidth / containerRef.current.clientHeight;
                            camera.updateProjectionMatrix();
                            renderer.setSize(containerRef.current.clientWidth, containerRef.current.clientHeight);
                    ...
                    let raf = 0;
                    const animate = {
                        "SevenStarsScene.useEffect.init.animate": ()=>{
                            raf = requestAnimationFrame(animate);
                            controls.update();
                            // 更新方位标签位置
                            orientPts.forEach({
                                "SevenStarsScene.useEffect.init.animate": (param)=>{
                                    let { point, label } = param;
                                    var _containerRef_current, _containerRef_current1;
                                    const vector = point.position.clone().project(camera);
                                    const x2d = (vector.x * 0.5 + 0.5) * (((_containerRef_current = containerRef.current) === null || _containerRef_current === void 0 ? void 0 : _containerRef_current.clientWidth) || 0);
                                    const y2d = (-vector.y * 0.5 + 0.5) * (((_containerRef_current1 = containerRef.current) === null || _containerRef_current1 === void 0 ? void 0 : _containerRef_current1.clientHeight) || 0);
                                    label.style.left = "".concat(x2d, "px");
                                    label.style.top = "".concat(y2d, "px");
                                }
                            }["SevenStarsScene.useEffect.init.animate"]);
                            // 更新极点标签位置
                            if (northPoleLabel && southPoleLabel) {
                                const northPole = objectsToRemove.find({
                                    "SevenStarsScene.useEffect.init.animate.northPole": (obj)=>obj.position && obj.position.y > 0
                                }["SevenStarsScene.useEffect.init.animate.northPole"]);
                                const southPole = objectsToRemove.find({
                                    "SevenStarsScene.useEffect.init.animate.southPole": (obj)=>obj.position && obj.position.y < 0
                                }["SevenStarsScene.useEffect.init.animate.southPole"]);
                                if (northPole) {
                                    var _containerRef_current, _containerRef_current1;
                                    const vector = northPole.position.clone().project(camera);
                                    const x2d = (vector.x * 0.5 + 0.5) * (((_containerRef_current = containerRef.current) === null || _containerRef_current === void 0 ? void 0 : _containerRef_current.clientWidth) || 0);
                                    const y2d = (-vector.y * 0.5 + 0.5) * (((_containerRef_current1 = containerRef.current) === null || _containerRef_current1 === void 0 ? void 0 : _containerRef_current1.clientHeight) || 0);
                                    northPoleLabel.style.left = "".concat(x2d, "px");
                                    northPoleLabel.style.top = "".concat(y2d, "px");
                                }
                                if (southPole) {
                                    var _containerRef_current2, _containerRef_current3;
                                    const vector = southPole.position.clone().project(camera);
                                    const x2d = (vector.x * 0.5 + 0.5) * (((_containerRef_current2 = containerRef.current) === null || _containerRef_current2 === void 0 ? void 0 : _containerRef_current2.clientWidth) || 0);
                                    const y2d = (-vector.y * 0.5 + 0.5) * (((_containerRef_current3 = containerRef.current) === null || _containerRef_current3 === void 0 ? void 0 : _containerRef_current3.clientHeight) || 0);
                                    southPoleLabel.style.left = "".concat(x2d, "px");
                                    southPoleLabel.style.top = "".concat(y2d, "px");
                                }
                            }
                            renderer.render(scene, camera);
                        }
                    ...
                    cleanup = ({
                        "SevenStarsScene.useEffect.init": ()=>{
                            ...
                            (_overlayRef_current = overlayRef.current) === null || _overlayRef_current === void 0 ? void 0 : _overlayRef_current.querySelectorAll(".label").forEach({
                                "SevenStarsScene.useEffect.init": (n)=>n.remove()
                            }["SevenStarsScene.useEffect.init"]);
                        }
                    })["SevenStarsScene.useEffect.init"];
                }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$styled$2d$jsx$2f$style$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                id: "ec0d61eff66e4518",
                children: ".label.jsx-ec0d61eff66e4518{color:#fff;background:rgba(0,0,0,.5);border-radius:4px;padding:2px 4px;font-size:12px}"
            }, void 0, false, void 0, this)
        ]
    }, void 0, true, {
        fileName: "[project]/src/app/earth/page.tsx",
...
_s1(SevenStarsScene, "xBcd/jwoAbG538YZmjauoniVJQQ=");
_c1 = SevenStarsScene;
function TibetanCyclicYear() {
    ...
    const calculate = ()=>{
        ...
        setResult("".concat(year, " 年是 【").concat(ganzhiList[index], "】年"));
    };
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TibetanCyclicYear.useEffect": ()=>{
            calculate(); // 初始化
...
_s2(TibetanCyclicYear, "MvP4kF2zl9QLAkJ0FMOVqQptEpE=");
_c2 = TibetanCyclicYear;
function EarthPage() {
    _s3();
    const [activeTab, setActiveTab] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("十二宫");
    // 三个不同的内容组件
    const renderContent = ()=>{
        switch(activeTab){
            case "十二宫":
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ZodiacScene, {}, void 0, false, {
                        fileName: "[project]/src/app/earth/page.tsx",
                        lineNumber: 1040,
                        columnNumber: 13
                    }, this)
            ...
            case "七星轨迹":
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "flex-1 flex flex-col",
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(SevenStarsScene, {}, void 0, false, {
                        fileName: "[project]/src/app/earth/page.tsx",
                        lineNumber: 1047,
                        columnNumber: 13
                    }, this)
            ...
            case "藏历绕迥纪年":
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(TibetanCyclicYear, {}, void 0, false, {
                    fileName: "[project]/src/app/earth/page.tsx",
                    lineNumber: 1052,
                    columnNumber: 16
                }, this);
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                className: "px-6 py-2 rounded-lg transition-all duration-300 ".concat(activeTab === "十二宫" ? "bg-blue-600 text-white shadow-lg" : "bg-gray-700 text-white hover:bg-gray-600"),
                                children: "十二宫"
                            }, void 0, false, {
                                fileName: "[project]/src/app/earth/page.tsx",
                                lineNumber: 1097,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                className: "px-6 py-2 rounded-lg transition-all duration-300 ".concat(activeTab === "七星轨迹" ? "bg-blue-600 text-white shadow-lg" : "bg-gray-700 text-white hover:bg-gray-600"),
                                children: "七星轨迹"
                            }, void 0, false, {
                                fileName: "[project]/src/app/earth/page.tsx",
                                lineNumber: 1107,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                className: "px-6 py-2 rounded-lg transition-all duration-300 ".concat(activeTab === "藏历绕迥纪年" ? "bg-blue-600 text-white shadow-lg" : "bg-gray-700 text-white hover:bg-gray-600"),
                                children: "藏历绕迥纪年"
                            }, void 0, false, {
                                fileName: "[project]/src/app/earth/page.tsx",
                                lineNumber: 1117,
...
_s3(EarthPage, "0O+jtkyLMFfybks4WunUQi9rlrc=");
_c3 = EarthPage;
var _c, _c1, _c2, _c3;
__turbopack_context__.k.register(_c, "ZodiacScene");
__turbopack_context__.k.register(_c1, "SevenStarsScene");
__turbopack_context__.k.register(_c2, "TibetanCyclicYear");
__turbopack_context__.k.register(_c3, "EarthPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_48666e4c._.js.map